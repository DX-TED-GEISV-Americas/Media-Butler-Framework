...
{
    /// <summary>
    /// AMS Standard transcoding step
    /// </summary>
    class StandarEncodeStep : StepHandler
    {
        ...
        /// <summary>
        /// Send Job and task error message to Trace and Reuqest exception list
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">AMs IJob</param>
        /// <param name="e">null</param>
        private void MyEncodigSupport_JobUpdate(object sender, EventArgs e)
        {
            string message = (string)sender;

            if (!myRequest.MetaData.Any(item => item.Key == MBFConfiguration.TranscodingAdvance))
            {
                myRequest.MetaData.Add(MBFConfiguration.TranscodingAdvance, message);
            }
            else
            {
                myRequest.MetaData[MBFConfiguration.TranscodingAdvance] = message;
            }
            myStorageManager.PersistProcessStatus(myRequest);
        }

        /// <summary>
        /// Odempotence control to avoid trigger multiples jobs
        /// </summary>
        /// <returns>tru idf JOB already is running</returns>
        ...
        /// <summary>
        /// Delete existing outputs on step error
        /// </summary>
