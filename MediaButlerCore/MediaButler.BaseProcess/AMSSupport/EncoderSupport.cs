    ...
    public class EncoderSupport : IEncoderSupport
    {
        ...
        public string LoadEncodeProfile(string profileInfo, string ProcessConfigConn)
        {
            ...
            else
            {
                ...
                CloudBlobContainer container = blobClient.GetContainerReference(MediaButler.Common.Configuration.MBFConfiguration.ButlerExternalInfoContainer);
