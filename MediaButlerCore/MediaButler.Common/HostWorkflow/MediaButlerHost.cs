...
namespace MediaButler.Common.HostWorkflow
{
    ...
    public class MediaButlerHost
    {
        ...
        private void Setup(string ConfigurationStorageConnectionString)
        {
            ...
            _Configuration.poisonQueue = MBFConfiguration.ButlerFailedQueue;
            _Configuration.inWorkQueueName = MBFConfiguration.ButlerSendQueue;
        ...
        public async Task ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            myProcessHandler = new ProcessHandler(_Configuration.ProcessConfigConn);
            //Infinite Loop
            while (true)
            {
                //2. Execute
